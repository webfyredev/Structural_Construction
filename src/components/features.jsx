...
export default function Features(){
    return(
        <>
            <motion.div {...scrollRight} className="w-full lg:h-100 h-auto grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 px-10 py-17">
                <motion.div {...cardHover} className="w-[95%] h-65 mb-5 lg:mb-0 lg:h-full p-5 flex flex-col items-center shadow-lg">
