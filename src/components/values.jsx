...
export default function Values (){
    return(
        <>
            <div className="w-full flex flex-col items-center p-10 mt-10">
                ...
                <motion.p {...scrollUpNext} className="text-gray-600 text-xs md:text-sm">Building with integrity, precision, and long-term value, for every project, every time.</motion.p>
                <div className="w-full p-5 mt-5 grid grid-cols-1 sm:grid-cols-1 md:grid=cols-2 lg:grid-cols-3 gap-5">
