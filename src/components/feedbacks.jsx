    ...
    return(
        <>
            <div className="w-full p-3 lg:p-10 flex flex-col items-center mb-5">
                <motion.h2 {...scrollUp} className="text-3xl font-bold mt-10 lg:mt-3 bg-gradient-to-r from-orange-500 to-orange-400 bg-clip-text text-transparent h-10">Projects Feedbacks</motion.h2>
