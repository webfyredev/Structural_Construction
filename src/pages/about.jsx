...
export default function About (){
    ...
    return(
        <>
            ...
            img = {aboutHeader}
            />
            <div className="w-full lg:h-110 md:110 h-auto lg:flex lg:flex-row p-5 justify-between mt-10 flex flex-col space-x-5">
                <motion.div {...scrollLeft} className="w-full  md:w-full md:h-[45%] lg:w-1/2 lg:h-full h-[45%] md:h-[45%] p-3 mb-5 lg:mb-0">
                ...
                <motion.img {...scrollRight} src={aboutImg}  className="w-1/2 rounded-xl lg:h-full h-70 md:h-100 object-cover hover:scale-99 transition duration-200"/>

            </div>
            <div className="w-full p-5 my-5 flex flex-row space-x-10">
                <div className="w-1/2 p-5 relative group overflow-hidden">
                    <img src={abtImg1} className="w-full h-120 object-cover rounded-xl" alt="" />
                    <img src={abtImg2} className="object-cover absolute bottom-10 right-10 border-2 border-white z-1 w-70 h-50 rounded-xl group-hover:scale-105 transition overflow-hidden" alt="" />
                </div>
                <div className="w-1/2 p-5 flex flex-col items-left">
                    <h3 className="font-bold text-2xl bg-gradient-to-r from-orange-to-r from-orange-500 to-orange-400 bg-clip-text text-transparent">
                        - Mission
                    </h3>
                    ...
                    <h3 className="font-bold text-2xl bg-gradient-to-r from-orange-to-r from-orange-500 to-orange-400 bg-clip-text text-transparent mt-2">
                        - Vission
                    </h3>
                    <p className="text-[13px] my-2">
            ...
            <div className="w-full p-5 mt-10 flex flex-col items-center">
                ...
                <div className="w-full p-5 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 gap-5">
                    {about_process.map((process) => (
                        ...
                        {...scrollUp}
                            ...
                            <h3 className="text-base font-semibold text-[#262A4F]">
                                {process.title}
                            </h3>
            ...
            <div className="w-full h-auto flex flex-col lg:flex lg:flex-row px-5 py-10 items-center justify-evenly mt-10">
                <motion.img {...scrollLeft} src={aboutSlider} className="lg:w-[45%] w-full h-[30%] md:h-[30%] lg:h-full rounded-xl"/>
                <div className="lg:w-[45%] w-full h-[50%] lg:h-full flex flex-col lg:px-5 py-2 justify-between items-center space-y-3">
                    {about_data.map((data) => (
                        <motion.div {...scrollUpNext} {...cardHover}  className="bg-white w-full h-auto flex flex-row items-center justify-center shadow-sm rounded-xl hover:shadow-lg px-3 py-3 transition">
                            <data.icon  className="w-12 h-12 text-orange-500 mr-2 p-3 rounded-full bg-orange-100"/>
            ...
            <div className="w-full p-10 flex flex-col items-center mt-15">
                <motion.h2 {...scrollUp} className="text-3xl font-bold mb-2 text-orange-500 text-center">Our Safety & Quality Preferences</motion.h2>
                <motion.p {...scrollUpNext} className="text-gray-600 max-w-2xl mx-auto mb-5 text-center text-[13px] md:text-sm">
                    Every project we undertake follows strict safety and quality principles.
                </motion.p>
                <div className="p-5 w-full grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
