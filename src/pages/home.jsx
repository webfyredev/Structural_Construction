...
export default function Home() {
  ...
  return (
    ...
    <NavBar />
    <HeroSlider />
    <div className='w-full h-350 md:h-250 lg:h-140 flex lg:flex-row flex-col md:flex-col justify-between items-left lg:p-10 p-5'>
      <motion.div {...scrollLeft} className='lg:w-1/2 w-full h-[30%] md:h-[40%] lg:h-full flex flex-col p-5'>
      ...
      <motion.div {...scrollRight} className='w-full lg:w-1/2 h-[70%] md:h-[60%] lg:h-full lg:flex lg:flex-row flex flex-col md:flex-col md:flex'>
        <div className='w-full flex flex-col justify-evenly items-center md:w-full md:flex md:flex-row md:h-[50%] lg:w-1/2 h-[50%] lg:h-[95%] mt-6 lg:flex lg:flex-col lg:justify-evenly lg:items-center lg:p-3 p-3 group'>
          <motion.div {...cardHover} className='w-[95%] h-[45%] lg:w-[95%] lg:h-[45%] md:w-[45%] md:h-[80%] shadow-md p-5 hover:cursor-pointer hover:rounded-sm hover:shadow-lg'>
        ...
        <div className='w-full lg:w-1/2 h-[50%] flex flex-col justify-evenly items-center lg:h-[95%] md:flex md:flex-row lg:flex lg:flex-col lg:justify-evenly lg:items-center lg:p-3 p-3'>
          <motion.div {...cardHover} className='w-[95%] h-[45%] lg:w-[95%] lg:h-[45%] md:w-[45%] md:h-[80%] shadow-md p-5 hover:cursor-pointer hover:rounded-sm hover:shadow-lg'>
    ...
    <Features />
    <ServicesComponents />
    <div className='w-full lg:h-100 h-auto flex flex-col lg:flex lg:flex-row lg:justify-evenly lg:items-center lg:px-15 py-5 lg:mb-10 mb-5'>
      <motion.img {...scrollLeft} src={semBg} className='lg:w-[45%] lg:h-[95%] object-cover rounded-sm w-full h-[45%]' />
    ...
    <div className='w-full lg:h-100 h-auto flex flex-col lg:flex lg:flex-row lg:justify-evenly lg:items-center lg:px-15 py-5'>
      <motion.div {...scrollRight} className='w-full h-[45%] lg:w-[50%] lg:h-[95%] flex flex-col p-5'>
        <p className='text-xs font-semibold text-gray-400'>EXPLORE THE PROJECTS</p>
      ...
      <motion.img {...scrollLeft} src={semBg2} className='w-full h-[45%] lg:w-[45%] lg:h-[95%] object-cover rounded-sm' />
    ...
    <motion.div {...scrollRight} className="w-full  h-80 md:h-110 mt-20 flex items-center justify-center">
      <div className="w-[95%] h-[90%] rounded-sm bg-gradient-to-r from-orange-500 to-orange-400 flex flex-col items-center justify-center">
          <div className="w-[75%] h-60 flex flex-col items-center">
              <h1 className="text-2xl lg:text-5xl md:text-4xl font-bold text-white text-center my-5">Read To Build <br /> Your Dream Projects</h1>
